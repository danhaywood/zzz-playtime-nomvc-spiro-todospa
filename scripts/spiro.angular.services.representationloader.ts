...
module Spiro.Angular {
    ...
    export interface IRepLoader {
        populate: <T>(m: Spiro.HateoasModel, ignoreCache?: boolean, r?: Spiro.HateoasModel) => ng.IPromise<T>;
    }
    ...
    app.service("repLoader", function ($http, $q, $rootScope) {
        ...
        function getUrl(model: Spiro.HateoasModel): string {
        ...
        function getData(model: Spiro.HateoasModel): Object {
        ...
        repLoader.populate = function<T> (model: Spiro.HateoasModel, ignoreCache?: boolean, expected?: Spiro.HateoasModel) {
